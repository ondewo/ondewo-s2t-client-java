 ...
 * ({@code ondewo.s2t}), and anything sitting in a sibling package such as this one survives a
 ...
 * Speech2TextGrpc.Speech2TextBlockingStub stub =
 *     new BearerToken(accessToken).attachTo(Speech2TextGrpc.newBlockingStub(channel));
 * }</pre>
 */
