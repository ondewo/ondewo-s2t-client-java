...
class BearerTokenTest {
    ...
    void attachToReturnsAnAuthenticatedCopyOfEveryStubFlavour() {
        ...
        final BearerToken token = new BearerToken("s3cr3t");
        final Speech2TextGrpc.Speech2TextBlockingStub blocking =
                Speech2TextGrpc.newBlockingStub(channel);
        final Speech2TextGrpc.Speech2TextFutureStub future = Speech2TextGrpc.newFutureStub(channel);
        final Speech2TextGrpc.Speech2TextStub async = Speech2TextGrpc.newStub(channel);
